...
def convert_state_dict(tilert_state_dict: dict) -> dict:
    ...
    key_casting_maps = {
        ...
        r"layers\.(\d+)\.ffn\.route_proj\.proj_weight": r"layers.\1.ffn.gate.weight",  # noqa: E501
    }
...
def test_e2e_forward_pass(model_config):
    ...
    x = torch.randint(0, model_args.vocab_size, (2, 128))
    ...
    ref_output = origin_model(x)
    tilert_output = tilert_model(x)
